...
The face uses Orbitron’s variable-font MEDIUM (weight 500) for the solid
center clock. The existing Google Sans outlined font remains solely for the
pre-existing outlined-AOD option because Orbitron supplies no outlined
counterpart. This notice applies only to the bundled Orbitron font and does
not license unrelated upstream files.
